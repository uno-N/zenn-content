...
emoji: "🎵"
type: "tech"
topics: ["api", "python", "音楽生成ai", "初心者", "websocket"]
published: true
---
...
基本的に、小脳記憶シリーズは、開発日記で解説したことは省いていきます。
[【開発日記：#4】音楽創造アプリに組み込む音楽生成AIの選定とAPI検証の意思決定プロセス](https://zenn.dev/uno22/articles/dev-diary-04-music-api)
...
パラメータ反映しているかを判定する分析ツールを使用して、試してみた結果がこれ。
